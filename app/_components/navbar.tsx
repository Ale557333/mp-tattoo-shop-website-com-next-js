  ...
  return (
    ...
    >
      ...
      <ul className="flex gap-6 md:text-3xl text-xl">
        <li className={`${isActive(pathName, 'servicos')} transition-all duration-500 hover:text-yellow-400`}>
          <Link href="/servicos">Serviços</Link>
        </li>
        <li className={`${isActive(pathName, 'sobre')} transition-all duration-500 hover:text-yellow-400`}>
          <Link href="/sobre">Sobre Mim</Link>
        </li>
        <li>
          <Link href="/contato" className='flex flex-col'>
            <span className={`text-right ${isActive(pathName, 'contato')} transition-all duration-500 hover:text-yellow-400`}>
              Contato
              <br />
            </span>
          </Link>
